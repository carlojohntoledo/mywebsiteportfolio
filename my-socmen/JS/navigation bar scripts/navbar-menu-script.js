    ...
    <div class="menu-btn-panel blue-bordered">
        <div class="radio-inputs">
            ...
            <input name="radio" type="radio" ${bodyData === "activities" ? "checked" : ""}/>
                <svg class="menu-icon" width="2rem" height="2rem" fill="var(--text-color)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
            ...
            <label class="menu-radio" data-href="services.html">
                ...
                <svg class="menu-icon" id="menu-service-icon" width="2rem" height="2rem" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="var(--text-color)">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier"> 
                        <g> 
            ...
            <label class="menu-radio" data-href="projects.html">
                ...
                <svg class="menu-icon" width="2rem" height="2rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M5.4 3h13.2A2.4 2.4 0 0 1 21 5.4v13.2a2.4 2.4 0 0 1-2.4 2.4H5.4A2.4 2.4 0 0 1 3 18.6V5.4A2.4 2.4 0 0 1 5.4 3ZM9 4h2v5h9v2h-9v9H9v-9H4V9h5V4Z" fill="var(--text-color)"></path>
                    </g>
                </svg>
        ...
        <div class="extras-dropdown-button-container">
            ...
            <div class="extras-popup">
                ...
                <ul>
                    ...
                    <a href="#">
                        <li id="theme-toggle">Theme Toggle</li>
                    </a>
                    <a href="#" id="logoutBtn" class="oauthButton">
                        <li>Log out</li>
                    </a>
                </ul>
            </div>
