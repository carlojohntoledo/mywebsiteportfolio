...
document.addEventListener("DOMContentLoaded", () => {
    const editProfileBtn = document.getElementById("edit-profile-button"); // adjust selector if different
    if (editProfileBtn) {
    ...
    const editSkillBtn = document.querySelector(".add-new-skill"); // adjust selector if different
    if (editSkillBtn) {
    ...
    const editCertificateBtn = document.querySelector(".add-new-certificate"); // adjust selector if different
    if (editCertificateBtn) {
        editCertificateBtn.addEventListener("click", () => {
            console.log("✅ Edit Certificate button clicked"); // test log
